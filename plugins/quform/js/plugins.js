 ...
 */
(function (b) {
  b.preloadImages = function (d, a) {
    for (a = a ? a : "", f = [], c = 0; c < d.length; c++) {
      var e = new Image();
      e.src = a + d[c];
      f.push(e);
    }
...
(function (b) {
    ...
    firstScrollable: function (e) {
      ...
      this.each(function () {
        if (!(this == document || this == window)) {
          ...
          0 < d[f]()
            ? c.push(this)
            : (d[f](1), (a = 0 < d[f]()) && c.push(this), d[f](0));
        }
      });
      c.length ||
        this.each(function () {
    ...
    smoothScroll: function (e) {
      ...
      this.unbind("click.smoothscroll").bind(
        ...
        function (e) {
          ...
          l &&
            (e.preventDefault(),
            b.extend(n, c, { scrollTarget: c.scrollTarget || p, link: this }),
            b.smoothScroll(n));
        }
      );
      return this;
  ...
  b.smoothScroll = function (e, c) {
    ...
    d = {};
    "number" === typeof e
      ? ((a = b.fn.smoothScroll.defaults), (d = e))
      : ((a = b.extend({}, b.fn.smoothScroll.defaults, e || {})),
        a.scrollElement &&
          ((j = "position"),
          "static" == a.scrollElement.css("position") &&
            a.scrollElement.css("position", "relative")));
    a = b.extend({ link: null }, a);
    h = "left" == a.direction ? "scrollLeft" : h;
    a.scrollElement
      ? ((f = a.scrollElement), (g = f[h]()))
      : (f = b("html, body").firstScrollable());
    a.beforeScroll.call(f, a);
    d =
      "number" === typeof e
        ? e
        : c ||
          (b(a.scrollTarget)[j]() && b(a.scrollTarget)[j]()[a.direction]) ||
          0;
    k[h] = d + g + a.offset;
    g = a.speed;
  ...
  !(function (a) {
    ...
    function r(a, c, f) {
      ...
      if (
        ...
        if (((j = a.attr(k.content.attr)), k.content.attr === C || !j))
          return C;
        k.content.text = j;
      }
      if (
      ...
      return (
        ...
        k.suppress &&
          (l = a.attr("title")) &&
          a.removeAttr("title").attr(ab, l).attr("title", ""),
        (g = new e(a, k, c, !!j)),
        a.data(Q, g),
        g
      );
        ...
        return (
          ...
          (this.tooltip =
            ...
            b =
              d("<div/>", {
                id: this._id,
                class: [Q, X, e.style.classes, f.posClass].join(" "),
                width: e.style.width || "",
          ...
          i &&
            (this._createTitle(),
            d.isFunction(i) || l.push(this._updateTitle(i, C))),
          j && this._createButton(),
          d.isFunction(h) || l.push(this._updateContent(h, C)),
          (this.rendered = B),
          this._setWidget(),
          d.each(P, function (a) {
            var b;
          ...
          this._when(l).then(function () {
            c._trigger("render"),
              ...
              c.hiddenDuringWait ||
                (!e.show.ready && !a) ||
                c.toggle(B, f.event, C),
              (c.hiddenDuringWait = C);
          }),
          (w.api[this.id] = this),
          this
        );
        ...
        function b() {
          if (!this.destroyed) {
            ...
            b
              ...
              this.options.suppress && c && b.attr("title", c).removeAttr(ab),
              this._unassignEvents(),
              (this.options =
                this.elements =
                this.cache =
      ...
      (z = x.checks =
        {
          builtin: {
            ...
            "^position.(my|at)$": function (a, b, c) {
              "string" == typeof c &&
                (this.position[b] = a[b] = new y(c, "at" === b));
            },
    ...
    (x.set = function (a, b) {
      ...
      (x._createTitle = function () {
        ...
        a.titlebar && this._removeTitle(),
          (a.titlebar = d("<div />", {
            class:
              Q + "-titlebar " + (this.options.style.widget ? k("header") : ""),
          })
            .append(
              (a.title = d("<div />", {
                id: b,
      ...
      (x.reposition = function (c, e) {
        ...
        if (d.isArray(m) && 2 === m.length)
          ...
          if (
            ...
            return this;
          m[0] === b || m[0] === a
            ? ((v = bb.iOS ? a.innerWidth : m.width()),
              (w = bb.iOS ? a.innerHeight : m.height()),
              m[0] === a &&
                (y = {
                  top: (p || m).scrollTop(),
                  left: (p || m).scrollLeft(),
            ...
            ((bb.iOS > 3.1 && bb.iOS < 4.1) ||
              (bb.iOS >= 4.3 && bb.iOS < 4.33) ||
              (!bb.iOS && "fixed" === x)) &&
                ...
                : d.isFunction(l.effect) &&
                  ...
                  k.queue(function (a) {
                    d(this).css({ opacity: "", height: "" }),
                      bb.ie && this.style.removeAttribute("filter"),
                      a();
                  })),
              (this.positioning = C),
              this)
      ...
      (x.reposition.offset = function (a, c, e) {
        ...
        var g,
          ...
          l = !!bb.ie && "CSS1Compat" !== b.compatMode,
          m = e[0];
        do
                  ...
                  a
                    ? (this.mouse && (e.origin = d.event.fix(this.mouse)),
                      ...
                      !A &&
                        "mouse" === m.target &&
                        m.adjust.mouse &&
                        (d(b).bind("mousemove." + Q, this._storeMouse),
                        (A = B)),
                    ...
                    : (clearTimeout(this.timers.show),
                      delete e.origin,
                      A &&
                        !d(U + '[tracking="true"]:visible', l.solo).not(g)
                          .length &&
                        (d(b).unbind("mousemove." + Q), (A = C)),
                      this.blur(c)),
                  (j = d.proxy(function () {
                    a
                      ? (bb.ie && g[0].style.removeAttribute("filter"),
                        g.css("overflow", ""),
      ...
      (x.disable = function (a) {
        return this.destroyed
          ...
          : ("toggle" === a
            ...
            this.rendered &&
              this.tooltip.toggleClass($, a).attr("aria-disabled", a),
            (this.disabled = !!a),
            this);
      }),
      (x.enable = function () {
        ...
        b.button && b.button.remove(),
          (b.button = e.jquery
            ...
            : d("<a />", {
                class:
                  "qtip-close " +
                  (this.options.style.widget ? "" : Q + "-icon"),
                title: g,
                "aria-label": g,
              }).prepend(
                d("<span />", {
            ...
            : ((k = h(d.extend(B, {}, a))),
              this.each(function (a) {
                ...
                return (
                  ...
                  (c =
                    !c || c === C || c.length < 1 || w.api[c] ? w.nextid++ : c),
                  (b = r(d(this), c, k)),
                  b === C
                    ? B
                    : ((w.api[c] = b),
    ...
    var fb,
      ...
      kb = "transparent",
      lb = " !important",
      mb = !!b.createElement("canvas").getContext,
      nb = /rgba?\(0, 0, 0(, 0)?\)|transparent|#123456/i,
      ob = {},
      pb = ["Webkit", "O", "Moz", "ms"];
    if (mb)
      var qb = a.devicePixelRatio || 1,
        rb = (function () {
    ...
    d.extend(v.prototype, {
      init: function (a) {
        ...
        (c =
          this.element =
          a.elements.tip =
            d("<div />", { class: Q + "-tip" }).prependTo(a.tooltip)),
          mb
            ? ((b = d("<canvas />").appendTo(this.element)[0].getContext("2d")),
              (b.lineJoin = "miter"),
              (b.miterLimit = 1e5),
              b.save())
            : ((b = tb("shape", 'coordorigin="0,0"', "position:absolute;")),
      ...
      create: function () {
        var a = (this.corner =
          (mb || bb.ie) && this._parseCorner(this.options.corner));
        return (
        ...
        b || (b = this.qtip.cache.corner || this.corner),
          ...
          e[1] !== kb
            ? ((l = this.border = this._parseWidth(b, b[b.precedance])),
              p.border && 1 > l && !nb.test(e[1]) && (e[0] = e[1]),
          ...
          mb
            ? ((g = o[0].getContext("2d")),
              ...
              (h = this._calculateTip(r, q, sb)),
              (i = this._calculateTip(r, this.size, sb)),
              o.attr(G, k[0] * sb).attr(H, k[1] * sb),
              o.css(G, k[0]).css(H, k[1]),
              this._drawCoords(g, i),
              (g.fillStyle = e[1]),
              g.fill(),
              g.translate(j[0] * sb, j[1] * sb),
            ...
            : ((h = this._calculateTip(r)),
              (h =
                ...
                " xe"),
              (j[2] =
                l && /^(r|b)/i.test(b.string()) ? (8 === bb.ie ? 2 : 1) : 0),
              o
                .css({
        ...
        return (
          ...
          d.each(e, function (d, e) {
            ...
            e === M
              ? ((h = c === F ? J : I),
                (j[h] = "50%"),
                (j[gb + "-" + h] = -Math.round(b[c === F ? 0 : 1] / 2) + i))
      ...
      reposition: function (a, b, d) {
        ...
        if (this.enabled) {
          ...
          this.corner.fixed !== B &&
            ...
            (g.user = this.offset),
            (o.left = m === O && !!k.left) && f(E, J, L),
            (o.top = n === O && !!k.top) && f(F, I, K),
            this.element
              .css(p)
              .toggle(
                !((o.x && o.y) || (j.x === M && o.y) || (j.y === M && o.x))
              ),
      ...
      (fb.initialize = "render"),
      (fb.sanitize = function (a) {
