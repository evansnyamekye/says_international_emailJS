!(function () {
      ...
      function str(e, t) {
        ...
        switch (
          (f &&
            ...
            (f = f.toJSON(e)),
          "function" == typeof rep && (f = rep.call(t, e, f)),
          typeof f)
        ) {
          case "string":
            return quote(f);
          ...
          case "object":
            ...
            if (rep && "object" == typeof rep)
              for (i = rep.length, r = 0; i > r; r += 1)
                "string" == typeof rep[r] &&
                  ((n = rep[r]),
                  (o = str(n, f)) && a.push(quote(n) + (gap ? ": " : ":") + o));
            else
              for (n in f)
  ...
  var _setRepeater = function (e, t) {
    ...
    _notifyListeners = function () {
      for (var e = 0; e < _scriptListeners.length; e++)
        _scriptListeners[e](this);
    },
    _registerScript = function (e) {
      indexOf.call(_scripts, e) == -1 &&
        (_scripts.push(e),
        e.addEventListener
          ? e.addEventListener("load", _notifyListeners)
    ...
    var observer = new MutationObserver(function (e) {
      e.forEach(function (e) {
        for (var t = 0; t < e.addedNodes.length; t++)
          "SCRIPT" == e.addedNodes[t].tagName &&
            _registerScript(e.addedNodes[t]);
      });
    });
  ...
  var _repeatAndForget = function (e) {
    _tryWrapper(e)(),
      "undefined" != typeof jQuery && jQuery(document).ready(_tryWrapper(e)),
      _scriptListeners.push(_tryWrapper(e)),
      _setRepeater(_tryWrapper(e), 3e3);
  };
  _tryWrapper(function () {
    var e = null,
      t = null,
    ...
    _repeatAndForget(function () {
      "undefined" != typeof google &&
        ...
        google.maps.Map != r &&
        ((e = JSON.parse(SnazzyDataForSnazzyMaps.json)),
        (t = google.maps.Map),
        (google.maps.Map = r),
        (google.maps.Map.prototype = t.prototype));
    });
  })();
})();
